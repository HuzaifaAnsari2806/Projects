...
import pint
from .utils import number_str_to_float,convert_to_system
from .validators import validate_unit_of_measurements
...
class RecipeIngredient(models.Model):
    ...
    unit=models.CharField(max_length=50,validators=[validate_unit_of_measurements])
    directions=models.TextField(blank=True,null=True)
    timestamp=models.DateTimeField(auto_now_add=True)
    updated=models.DateTimeField(auto_now=True)
    active=models.BooleanField(default=True)
    ...
    def get_image_url(self):
        ...
        return reverse("recipes:ingredient-image", kwargs=kwargs)
